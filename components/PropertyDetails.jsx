...
const PropertyDetails = ({property}) => {
  return (
    <main>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mt-6">
                <iframe src="https://www.google.com/maps/embed?pb=!1m10!1m8!1m3!1d82346.40134102933!2d23.9938849!3d49.8363498!3m2!1i1024!2i768!4f13.1!5e0!3m2!1suk!2sua!4v1713006505916!5m2!1suk!2sua" width='100%' height="450" style={{border:0}} allowFullscreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
            </div>
          </main>
